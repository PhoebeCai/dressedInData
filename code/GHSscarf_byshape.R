...
linePlot = function(data, file, stripeWidth = 2, outerRad = 1.25, innerRad = 0.5, #stripeGap = 0.5, 
  ...
  if(ntime == 1){
    ...
    for (i in 1:nlines){
      ...
      symbols(x, y, stars = starsDims(outerRad*stripeWidth,data$starsType[i]), fg = as.character(data$visitColor[i]), bg = as.character(data$visitColor[i]), add = TRUE, inches = FALSE)
      #symbols(x, y, stars = starsDims(innerRad*stripeWidth,data$starsType[i]), fg = as.character(data$stripeColorRank[i]), bg = as.character(data$stripeColorRank[i]), add = TRUE, inches = FALSE)  
      #  abline(v= , lwd) #seems like setting line widths accurately with lwd will be tricky, use rectangles instead
      rectXleftedge<-rectXleftedge + stripeWidth + stripeGap
    }
  }
  if (ntime == 2){
    ...
    for (i in seq(1, nlines, 2)){
      ...
      symbols(x1, y1, stars = starsDims(outerRad*stripeWidth,data$starsType[i]), fg = as.character(data$visitColor[i]), bg = as.character(data$visitColor[i]), add = TRUE, inches = FALSE)
      #symbols(x1, y1, stars = starsDims(innerRad*stripeWidth,data$starsType[i]), fg = as.character(data$stripeColorRank[i]), bg = as.character(data$stripeColorRank[i]), add = TRUE, inches = FALSE)  
      ...
      symbols(x2, y2, stars = starsDims(outerRad*stripeWidth,data$starsType[i+1]), fg = as.character(data$visitColor[i+1]), bg = as.character(data$visitColor[i+1]), add = TRUE, inches = FALSE)
      #symbols(x2, y2, stars = starsDims(innerRad*stripeWidth,data$starsType[i+1]), fg = as.character(data$stripeColorRank[i+1]), bg = as.character(data$stripeColorRank[i+1]), add = TRUE, inches = FALSE)  
...
for (i in 1:length(partA))
  linePlot(partA[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partA", i, "byShape3.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partC))  
  linePlot(partC[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partC", i, "byShape3.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partE))  
  linePlot(partE[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partE", i, "byShape3.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partG))  
  linePlot(partG[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partG", i, "byShape3.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partH))  
  linePlot(partH[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partH", i, "byShape3.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partI))  
  linePlot(partI[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partI", i, "byShape3.jpg", sep=""), sortType="byAmount")


for (i in 2:length(partB))  
  linePlot(partB[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partB", i, "byShape3.jpg", sep=""), sortType="byAmountV2")
for (i in 2:length(partJ))  
  linePlot(partJ[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partJ", i, "byShape3.jpg", sep=""), sortType="byAmountV2")
for (i in 2:length(partD))  
  linePlot(partD[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partD", i, "byShape3.jpg", sep=""), sortType="byAmountV2")
for (i in 2:length(partF))  
  linePlot(partF[[i]], paste("Desktop/GHSdataSept2014/plots/scarfPlots/partF", i, "byShape3.jpg", sep=""), sortType="byAmountV2")
