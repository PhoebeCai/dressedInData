...
linePlot = function(data, file, stripeWidth = 1.4, outerRad = 2, innerRad = .65, #stripeGap = 0.5, 
                    #stripeGapSm = .5, stripeGapLg = 1.5,
                    sortType) {
  
  #FOR THE TIE
  #Edit the strip width
  #Phoebe put it at 3, a litle too thick for the template
  #Try 2--might have to add stripe spacing for this to work!
  stripeGap <-1
  #the participant I want is C graph 1 (FR) (id is C1008)

  ntime<-length(unique(data$Visit))
  #Was 4 and 15, LP change to 4.7 width and 20 height
  plotWidth = 4.7
  plotHeight = 20
...
#I want participant C for the tie and the scarf
for (i in 1:length(partC))  
  linePlot(partC[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partC", i, "OverlapLP.jpg", sep=""), sortType="byAmount")




for (i in 1:length(partA))
  linePlot(partA[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partA", i, "noOverlap.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partC))  
  linePlot(partC[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partC", i, "noOverlap.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partE))  
  linePlot(partE[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partE", i, "noOverlap.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partG))  
  linePlot(partG[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partG", i, "noOverlap.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partH))  
  linePlot(partH[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partH", i, "noOverlap.jpg", sep=""), sortType="byAmount")
for (i in 1:length(partI))  
  linePlot(partI[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partI", i, "noOverlap.jpg", sep=""), sortType="byAmount")


for (i in 2:length(partB))  
  linePlot(partB[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partB", i, "noOverlap.jpg", sep=""), sortType="byAmountV2")
for (i in 2:length(partJ))  
  linePlot(partJ[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partJ", i, "noOverlap.jpg", sep=""), sortType="byAmountV2")
for (i in 2:length(partD))  
  linePlot(partD[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partD", i, "noOverlap.jpg", sep=""), sortType="byAmountV2")
for (i in 2:length(partF))  
  linePlot(partF[[i]], paste("Desktop/GHSdataSept2014/plots/tiePlots/partF", i, "noOverlap.jpg", sep=""), sortType="byAmountV2")
